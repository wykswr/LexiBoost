...
const AutoSearch = ({className, selectedDeck, query, filteredDecks, pending, setSelected, setQuery}) => {
    return (
        <div className={className}>
            <Combobox value={selectedDeck} onChange={setSelected}>
                <div className="relative mt-1">
                    ...
                    <Transition
                        show={!pending && query !== '' && selectedDeck !== query}
                        as={Fragment}
