        ...
        <nav className="bg-gradient-to-r from-gray-400 via-gray-300 to-gray-400 shadow-md">
            <div className="mx-auto px-4 sm:px-6 lg:px-2 flex items-center justify-between h-16">
                ...
                <div className="flex space-x-3">
                    ...
                    <button className="text-black hover:text-gray-50 hover:bg-gray-400 px-3 py-2 rounded-md text-sm font-medium hidden md:block">My Card Decks</button>
                    <button className="text-black hover:text-gray-50 hover:bg-gray-400 px-3 py-2 rounded-md text-sm font-medium hidden md:block">Marketplace</button>
